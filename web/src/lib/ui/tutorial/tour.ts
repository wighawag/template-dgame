		...
		steps: [
			{
				...
				popover: {
					title: 'Your timer',
					description:
						'reveal-or-die is a simultaneous turn based game with 2 phases, commit and reveal. The clock shows you the countdown of each phase. Once green you can play, once red you have to wait for the resolution to finish',
				},
			},
			{
				element: '#navigation',
